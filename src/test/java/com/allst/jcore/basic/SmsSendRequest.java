...
/**
 * @author June 2019/03/13 下午 04:00
 * @version 1.0
 */
public class SmsSendRequest {
    ...
    public SmsSendRequest(String account, String password, String msg, String phone, String sendtime, String report, String extend, String uid) {
        super();
        this.account = account;
        this.password = password;
        this.msg = msg;
